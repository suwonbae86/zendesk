...
describe('<Menu />', function () {
  ...
  describe('MenuItem nestedMenu', function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _userEvent["default"].hover(parent);
            ...
            case 7:
              ...
              _userEvent["default"].hover(child);
            ...
            case 14:
              ...
              _userEvent["default"].unhover(child);
    ...
    test('toggle on click', function () {
      ...
      _userEvent["default"].click(_react.screen.getByText('French'));

      expect(_react.screen.getByText('Camembert')).toBeVisible();

      _userEvent["default"].click(_react.screen.getByText('Cheese'));
    ...
    test('clicking an item in the nested menu closes the parent menu', function () {
      ...
      _userEvent["default"].click(_react.screen.getByText('Camembert'));
    ...
    test('3 levels deep', function () {
      ...
      _userEvent["default"].click(first);

      var second = _react.screen.getByText('Stinky');

      _userEvent["default"].click(second);

      var third = _react.screen.getByText('Camembert');

      _userEvent["default"].click(third);
