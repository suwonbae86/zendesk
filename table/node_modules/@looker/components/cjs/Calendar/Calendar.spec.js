...
var stories = _interopRequireWildcard(require("./Calendar.stories"));
...
describe('Calendar', function () {
  ...
  test('closes popover after single date selection', function () {
    ...
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_Dialog.DialogContext.Provider, {
      value: dialogContext
    }, _react["default"].createElement(Basic, {
  ...
  describe('Range selection', function () {
    test('shows draft selection on hover', function () {
      (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(Range, null));
    ...
    test('select start and end', function () {
      ...
      (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_Dialog.DialogContext.Provider, {
        value: dialogContext
      }, _react["default"].createElement(Range, {
    ...
    test('range spanning multiple months', function () {
      (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(Range, {
