...
describe('Space', function () {
  test('reversed', function () {
    ...
    expect(_react2.screen.getByTestId('space')).toHaveStyle('flex-direction: row-reverse;');
  });
  test('around + gap (all you get is around)', function () {
    ...
    expect(_react2.screen.getByTestId('space')).toHaveStyle('justify-content: space-around;');
  });
  ...
  test('between', function () {
    ...
    expect(_react2.screen.getByTestId('space')).toHaveStyle('justify-content: space-between;');
  });
  test('evenly', function () {
    ...
    expect(_react2.screen.getByTestId('space')).toHaveStyle('justify-content: space-evenly;');
  });
});
