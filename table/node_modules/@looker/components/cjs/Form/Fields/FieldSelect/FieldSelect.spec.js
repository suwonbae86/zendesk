...
describe('FieldSelect', function () {
  ...
  test('Floating label focus color', function () {
    ...
    _userEvent["default"].click(input1);

    expect(label1).toHaveStyle("color: ".concat(_designTokens.theme.colors.key));

    _userEvent["default"].click(_react2.screen.getByText('Kiwis'));

    expect(label1).toHaveStyle("color: ".concat(_designTokens.theme.colors.key));

    _userEvent["default"].click(_react2.screen.getByText('Open Dialog'));
    ...
    _userEvent["default"].click(input2);

    _userEvent["default"].click(_react2.screen.getByText('Kiwis'));

    expect(label2).toHaveStyle("color: ".concat(_designTokens.theme.colors.key));

    _userEvent["default"].click(_react2.screen.getByText('Button Dialog'));
